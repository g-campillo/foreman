 ...
 * Claude's mark.
 *
 * The official one, fetched from `https://cdn.simpleicons.org/claude` — a
 * normalised 24x24 single path of Anthropic's own starburst. This used to be
 * hand-drawn path data that only approximated it; do not "simplify" this back.
 * Anthropic's 248x248 original is at `https://claude.ai/favicon.svg` if the
 * higher-precision outline is ever wanted.
 *
